...
First of all, make a clone or [fork of this repository](https://github.com/rsms/ec2-webapp/fork) and replace all occurrences of `myapp` with a name of your choice. Same goes for `myapp` in this guide.
